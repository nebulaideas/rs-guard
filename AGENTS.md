...
**Current Status:** Phases 1–7 complete; v1.8.0 released. Multi-pass review, .rs-guardignore, language-aware prompts, llm-kernel hybrid architecture, per-variant temperature override, and multi-arch release binaries. The crate is published on crates.io and registered on crates.ai.
