...
///
/// Outbound secret redaction (`docs/RELEASE_1.6.0.md` `#102`): scans for
/// common secret patterns (Bearer tokens, API keys, GitHub PATs, private
/// keys, passwords) and replaces matches with `[REDACTED]`.
///
